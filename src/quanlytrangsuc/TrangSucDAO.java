...
public class TrangSucDAO {
    ...
    public TrangSucDAO(Connection connection) {
    ...
    public void update(TrangSuc trangSuc) throws SQLException, InvalidDataException {
        if (trangSuc instanceof DayChuyen) {
            updateDayChuyen((DayChuyen) trangSuc);
        } else if (trangSuc instanceof Nhan) {
            updateNhan((Nhan) trangSuc);
        } else if (trangSuc instanceof VongTay) {
            updateVongTay((VongTay) trangSuc);
        } else {
            throw new InvalidDataException("Loai trang suc khong hop le");
        }
    }
